...
**Languages & Aptitudes:** Python (NumPy, pandas, matplotlib, seaborn, statsmodels, scikit-learn, TensorFlow, Keras, Flask, Selenium), MATLAB, LabVIEW, SQL, Microsoft Office, Tableau, HTML/CSS, git, C, assembly
