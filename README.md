...
**Languages & Aptitudes:** Python (NumPy, pandas, matplotlib, seaborn, statsmodels, scikit-learn, TensorFlow, Keras, Flask, Selenium), MATLAB, SQL, LabVIEW, Microsoft Office, R, Tableau, HTML/CSS, git, C, assembly
